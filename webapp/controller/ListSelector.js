sap.ui.define([
		...
		return BaseObject.extend("nnnn.model.ListSelector", {
			 ...
			 * @return {nnnn.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
